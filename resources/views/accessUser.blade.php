                ...
                @foreach($acces ?? '' as $item)
                    ...
                    <div class="card-body">
                        ...
                        <button data-id="{{$item->id}}" data-name="{{$item->name}}
                            " data-key="{{$item->access_key}}" data-description="{{$item->description}}" data-icon="{{$item->icon}}"
                            class="btn btn-success btn-sm tt add-cart" data-toggle="tooltip" title="เพิ่มลงการยืม">
...
<script>
    ...
    //     let cart = new Cart($(this).attr("data-id"),$(this).attr("data-key"),$(this).attr("data-name"),$(this).attr("data-description"),$(this).attr("data-icon"),1)
    //     accessories.addAccess(cart)
    //     console.log(accessories.getListAccess())
    // })
</script>
@endsection
